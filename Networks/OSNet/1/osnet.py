...
#   model_path = '/home/wenzhe/Experiments/heu/Quantum/Counting-Trans/ablation/shanghaiA_osnet/train/model_best.pth'
#   state_dict = torch.load(model_path)#, map_location=torch.device('cpu'))#['state_dict']
# #   print(state_dict.keys())
#   state_dict['state_dict'].pop("module.de_pred.0.weight")
#   state_dict['state_dict'].pop("module.de_pred.0.bias")
#   state_dict['state_dict'].pop("module.de_pred.2.weight")
#   state_dict['state_dict'].pop("module.de_pred.2.bias")
#   state_dict['state_dict'].pop("module.de_pred.4.weight")
#   state_dict['state_dict'].pop("module.de_pred.4.bias")
#   state_dict['state_dict'].pop("module.de_pred.6.weight")
#   state_dict['state_dict'].pop("module.de_pred.6.bias")

#   vgg.load_state_dict(state_dict['state_dict'])
...
class decoder_student(nn.Module):
    def __init__(self,pretrained= True):
        ...
        # self.conv = nn.Conv2d(128,512,3,1,1)
        # model_path = '/home/wenzhe/Experiments/heu/Quantum/Counting-Trans/ablation/shanghaiA_osnet/train/model_best.pth'
        self.de_pred = nn.Sequential(
                                    ...
                                    nn.ReLU(),
                                    nn.ConvTranspose2d(128,40,4,stride=2,padding=1,output_padding=0,bias=True),
                                    nn.ReLU(),
                                    nn.ConvTranspose2d(40,1,4,stride=2,padding=1,output_padding=0,bias=True),
                                    nn.ReLU(),                                  
                                    )
