...
from .student1 import load_osnet_weights as student_net
...
class Model(nn.Module):
    ...
    def forward(self, x):
        ...
        experts = self.student(x)
        
        s_out = self.upsample_s(experts[4])

        return x1, x2, x3, x4, x5, s_out, experts
    
def teach():
    net = teacher_net()
    model_path = 'ablation/1.0/carpk/train/model_best.pth'
